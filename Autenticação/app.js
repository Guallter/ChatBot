    //34min https://www.youtube.com/watch?v=qEBoZ8lJR3k&t=1854s
    ...
    app.post("/auth/login",async(req,res)=>{
        ...
        if(!user){
            return res.status(404).json({msg: 'Usuário não encontrado!'}) //422 = não encontrado
        }
        ...
        try{
            const secrect = "1"//'process.env.SECRET' - GAMBIARRA
    ...
    mongoose
    .connect(
        "mongodb+srv://Gualter:8KZtfCKKPNaOqTeC@cluster0.vbpvhib.mongodb.net/?retryWrites=true&w=majority"
